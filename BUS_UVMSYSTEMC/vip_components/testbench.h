...
//        virtual_sequencer->vip_Slave3_RSP_seqr = uvc_slave3->agent->sequencer;
        ...
        uvc_master->agent->driver->item_collected_port_Master_REQ.connect(scoreboard1->listener_fromMaster);
        uvc_master->agent->monitor->item_collected_port_Master_RSP.connect(scoreboard1->listener_toMaster);
        uvc_slave0->agent->monitor->item_collected_port_Slave_REQ.connect(scoreboard1->listener_toSlave0);
        uvc_slave1->agent->monitor->item_collected_port_Slave_REQ.connect(scoreboard1->listener_toSlave1);
        uvc_slave2->agent->monitor->item_collected_port_Slave_REQ.connect(scoreboard1->listener_toSlave2);
        uvc_slave3->agent->monitor->item_collected_port_Slave_REQ.connect(scoreboard1->listener_toSlave3);
        uvc_slave0->agent->driver->item_collected_port_Slave_RSP.connect(scoreboard1->listener_fromSlave0);
        uvc_slave1->agent->driver->item_collected_port_Slave_RSP.connect(scoreboard1->listener_fromSlave1);
        uvc_slave2->agent->driver->item_collected_port_Slave_RSP.connect(scoreboard1->listener_fromSlave2);
        uvc_slave3->agent->driver->item_collected_port_Slave_RSP.connect(scoreboard1->listener_fromSlave3);
    }
