            ...
            while(true) {
              if (section==run) {
                if(!coveragePoints["Register_file_1"]){
                  ...
                  coveragePointsCount++;
                  std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_1\n";
                }
                ...
                if (rec) {
                  if(!coveragePoints["Register_file_2"]){
                    ...
                    coveragePointsCount++;
                    std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_2\n";
                  }
                  if (((DPtoRF_data.wrReq == RF_WR) and (DPtoRF_data.dst != 0))) {
                    if(!coveragePoints["Register_file_3"]){
                      coveragePoints["Register_file_3"] = true;
                      coveragePointsCount++;
                      std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_3\n";
                    }
                    if ((DPtoRF_data.dst == 1)) {
                      if(!coveragePoints["Register_file_4"]){
                        coveragePoints["Register_file_4"] = true;
                        coveragePointsCount++;
                        std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_4\n";
                      }
                      ...
                      if(!coveragePoints["Register_file_5"]){
                        ...
                        coveragePointsCount++;
                        std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_5\n";
                      }
                      if ((DPtoRF_data.dst == 2)) {
                        if(!coveragePoints["Register_file_6"]){
                          coveragePoints["Register_file_6"] = true;
                          coveragePointsCount++;
                          std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_6\n";
                        }
                        ...
                        if(!coveragePoints["Register_file_7"]){
                          ...
                          coveragePointsCount++;
                          std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_7\n";
                        }
                        if ((DPtoRF_data.dst == 3)) {
                          if(!coveragePoints["Register_file_8"]){
                            coveragePoints["Register_file_8"] = true;
                            coveragePointsCount++;
                            std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_8\n";
                          }
                          ...
                          if(!coveragePoints["Register_file_9"]){
                            ...
                            coveragePointsCount++;
                            std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_9\n";
                          }
                          if ((DPtoRF_data.dst == 4)) {
                            if(!coveragePoints["Register_file_10"]){
                              coveragePoints["Register_file_10"] = true;
                              coveragePointsCount++;
                              std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_10\n";
                            }
                            ...
                            if(!coveragePoints["Register_file_11"]){
                              ...
                              coveragePointsCount++;
                              std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_11\n";
                            }
                            if ((DPtoRF_data.dst == 5)) {
                              if(!coveragePoints["Register_file_12"]){
                                coveragePoints["Register_file_12"] = true;
                                coveragePointsCount++;
                                std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_12\n";
                              }
                              ...
                              if(!coveragePoints["Register_file_13"]){
                                ...
                                coveragePointsCount++;
                                std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_13\n";
                              }
                              if ((DPtoRF_data.dst == 6)) {
                                if(!coveragePoints["Register_file_14"]){
                                  coveragePoints["Register_file_14"] = true;
                                  coveragePointsCount++;
                                  std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_14\n";
                                }
                                ...
                                if(!coveragePoints["Register_file_15"]){
                                  ...
                                  coveragePointsCount++;
                                  std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_15\n";
                                }
                                if ((DPtoRF_data.dst == 7)) {
                                  if(!coveragePoints["Register_file_16"]){
                                    coveragePoints["Register_file_16"] = true;
                                    coveragePointsCount++;
                                    std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_16\n";
                                  }
                                  ...
                                  if(!coveragePoints["Register_file_17"]){
                                    ...
                                    coveragePointsCount++;
                                    std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_17\n";
                                  }
                                  if ((DPtoRF_data.dst == 8)) {
                                    if(!coveragePoints["Register_file_18"]){
                                      coveragePoints["Register_file_18"] = true;
                                      coveragePointsCount++;
                                      std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_18\n";
                                    }
                                    ...
                                    if(!coveragePoints["Register_file_19"]){
                                      ...
                                      coveragePointsCount++;
                                      std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_19\n";
                                    }
                                    if ((DPtoRF_data.dst == 9)) {
                                      if(!coveragePoints["Register_file_20"]){
                                        coveragePoints["Register_file_20"] = true;
                                        coveragePointsCount++;
                                        std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_20\n";
                                      }
                                      ...
                                      if(!coveragePoints["Register_file_21"]){
                                        ...
                                        coveragePointsCount++;
                                        std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_21\n";
                                      }
                                      if ((DPtoRF_data.dst == 10)) {
                                        if(!coveragePoints["Register_file_22"]){
                                          coveragePoints["Register_file_22"] = true;
                                          coveragePointsCount++;
                                          std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_22\n";
                                        }
                                        ...
                                        if(!coveragePoints["Register_file_23"]){
                                          ...
                                          coveragePointsCount++;
                                          std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_23\n";
                                        }
                                        if ((DPtoRF_data.dst == 11)) {
                                          if(!coveragePoints["Register_file_24"]){
                                            coveragePoints["Register_file_24"] = true;
                                            coveragePointsCount++;
                                            std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_24\n";
                                          }
                                          ...
                                          if(!coveragePoints["Register_file_25"]){
                                            ...
                                            coveragePointsCount++;
                                            std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_25\n";
                                          }
                                          if ((DPtoRF_data.dst == 12)) {
                                            if(!coveragePoints["Register_file_26"]){
                                              coveragePoints["Register_file_26"] = true;
                                              coveragePointsCount++;
                                              std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_26\n";
                                            }
                                            ...
                                            if(!coveragePoints["Register_file_27"]){
                                              ...
                                              coveragePointsCount++;
                                              std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_27\n";
                                            }
                                            if ((DPtoRF_data.dst == 13)) {
                                              if(!coveragePoints["Register_file_28"]){
                                                coveragePoints["Register_file_28"] = true;
                                                coveragePointsCount++;
                                                std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_28\n";
                                              }
                                              ...
                                              if(!coveragePoints["Register_file_29"]){
                                                ...
                                                coveragePointsCount++;
                                                std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_29\n";
                                              }
                                              if ((DPtoRF_data.dst == 14)) {
                                                if(!coveragePoints["Register_file_30"]){
                                                  coveragePoints["Register_file_30"] = true;
                                                  coveragePointsCount++;
                                                  std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_30\n";
                                                }
                                                ...
                                                if(!coveragePoints["Register_file_31"]){
                                                  ...
                                                  coveragePointsCount++;
                                                  std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_31\n";
                                                }
                                                if ((DPtoRF_data.dst == 15)) {
                                                  if(!coveragePoints["Register_file_32"]){
                                                    coveragePoints["Register_file_32"] = true;
                                                    coveragePointsCount++;
                                                    std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_32\n";
                                                  }
                                                  ...
                                                  if(!coveragePoints["Register_file_33"]){
                                                    ...
                                                    coveragePointsCount++;
                                                    std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_33\n";
                                                  }
                                                  if ((DPtoRF_data.dst == 16)) {
                                                    if(!coveragePoints["Register_file_34"]){
                                                      coveragePoints["Register_file_34"] = true;
                                                      coveragePointsCount++;
                                                      std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_34\n";
                                                    }
                                                    ...
                                                    if(!coveragePoints["Register_file_35"]){
                                                      ...
                                                      coveragePointsCount++;
                                                      std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_35\n";
                                                    }
                                                    if ((DPtoRF_data.dst == 17)) {
                                                      if(!coveragePoints["Register_file_36"]){
                                                        coveragePoints["Register_file_36"] = true;
                                                        coveragePointsCount++;
                                                        std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_36\n";
                                                      }
                                                      ...
                                                      if(!coveragePoints["Register_file_37"]){
                                                        ...
                                                        coveragePointsCount++;
                                                        std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_37\n";
                                                      }
                                                      if ((DPtoRF_data.dst == 18)) {
                                                        if(!coveragePoints["Register_file_38"]){
                                                          coveragePoints["Register_file_38"] = true;
                                                          coveragePointsCount++;
                                                          std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_38\n";
                                                        }
                                                        ...
                                                        if(!coveragePoints["Register_file_39"]){
                                                          ...
                                                          coveragePointsCount++;
                                                          std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_39\n";
                                                        }
                                                        if ((DPtoRF_data.dst == 19)) {
                                                          if(!coveragePoints["Register_file_40"]){
                                                            coveragePoints["Register_file_40"] = true;
                                                            coveragePointsCount++;
                                                            std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_40\n";
                                                          }
                                                          ...
                                                          if(!coveragePoints["Register_file_41"]){
                                                            ...
                                                            coveragePointsCount++;
                                                            std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_41\n";
                                                          }
                                                          if ((DPtoRF_data.dst == 20)) {
                                                            if(!coveragePoints["Register_file_42"]){
                                                              coveragePoints["Register_file_42"] = true;
                                                              coveragePointsCount++;
                                                              std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_42\n";
                                                            }
                                                            ...
                                                            if(!coveragePoints["Register_file_43"]){
                                                              ...
                                                              coveragePointsCount++;
                                                              std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_43\n";
                                                            }
                                                            if ((DPtoRF_data.dst == 21)) {
                                                              if(!coveragePoints["Register_file_44"]){
                                                                coveragePoints["Register_file_44"] = true;
                                                                coveragePointsCount++;
                                                                std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_44\n";
                                                              }
                                                              ...
                                                              if(!coveragePoints["Register_file_45"]){
                                                                ...
                                                                coveragePointsCount++;
                                                                std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_45\n";
                                                              }
                                                              if ((DPtoRF_data.dst == 22)) {
                                                                if(!coveragePoints["Register_file_46"]){
                                                                  coveragePoints["Register_file_46"] = true;
                                                                  coveragePointsCount++;
                                                                  std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_46\n";
                                                                }
                                                                ...
                                                                if(!coveragePoints["Register_file_47"]){
                                                                  ...
                                                                  coveragePointsCount++;
                                                                  std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_47\n";
                                                                }
                                                                if ((DPtoRF_data.dst == 23)) {
                                                                  if(!coveragePoints["Register_file_48"]){
                                                                    coveragePoints["Register_file_48"] = true;
                                                                    coveragePointsCount++;
                                                                    std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_48\n";
                                                                  }
                                                                  ...
                                                                  if(!coveragePoints["Register_file_49"]){
                                                                    ...
                                                                    coveragePointsCount++;
                                                                    std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_49\n";
                                                                  }
                                                                  if ((DPtoRF_data.dst == 24)) {
                                                                    if(!coveragePoints["Register_file_50"]){
                                                                      coveragePoints["Register_file_50"] = true;
                                                                      coveragePointsCount++;
                                                                      std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_50\n";
                                                                    }
                                                                    ...
                                                                    if(!coveragePoints["Register_file_51"]){
                                                                      ...
                                                                      coveragePointsCount++;
                                                                      std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_51\n";
                                                                    }
                                                                    if ((DPtoRF_data.dst == 25)) {
                                                                      if(!coveragePoints["Register_file_52"]){
                                                                        coveragePoints["Register_file_52"] = true;
                                                                        coveragePointsCount++;
                                                                        std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_52\n";
                                                                      }
                                                                      ...
                                                                      if(!coveragePoints["Register_file_53"]){
                                                                        ...
                                                                        coveragePointsCount++;
                                                                        std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_53\n";
                                                                      }
                                                                      if ((DPtoRF_data.dst == 26)) {
                                                                        if(!coveragePoints["Register_file_54"]){
                                                                          coveragePoints["Register_file_54"] = true;
                                                                          coveragePointsCount++;
                                                                          std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_54\n";
                                                                        }
                                                                        ...
                                                                        if(!coveragePoints["Register_file_55"]){
                                                                          ...
                                                                          coveragePointsCount++;
                                                                          std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_55\n";
                                                                        }
                                                                        if ((DPtoRF_data.dst == 27)) {
                                                                          if(!coveragePoints["Register_file_56"]){
                                                                            coveragePoints["Register_file_56"] = true;
                                                                            coveragePointsCount++;
                                                                            std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_56\n";
                                                                          }
                                                                          ...
                                                                          if(!coveragePoints["Register_file_57"]){
                                                                            ...
                                                                            coveragePointsCount++;
                                                                            std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_57\n";
                                                                          }
                                                                          if ((DPtoRF_data.dst == 28)) {
                                                                            if(!coveragePoints["Register_file_58"]){
                                                                              coveragePoints["Register_file_58"] = true;
                                                                              coveragePointsCount++;
                                                                              std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_58\n";
                                                                            }
                                                                            ...
                                                                            if(!coveragePoints["Register_file_59"]){
                                                                              ...
                                                                              coveragePointsCount++;
                                                                              std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_59\n";
                                                                            }
                                                                            if ((DPtoRF_data.dst == 29)) {
                                                                              if(!coveragePoints["Register_file_60"]){
                                                                                coveragePoints["Register_file_60"] = true;
                                                                                coveragePointsCount++;
                                                                                std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_60\n";
                                                                              }
                                                                              ...
                                                                              if(!coveragePoints["Register_file_61"]){
                                                                                ...
                                                                                coveragePointsCount++;
                                                                                std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_61\n";
                                                                              }
                                                                              if ((DPtoRF_data.dst == 30)) {
                                                                                if(!coveragePoints["Register_file_62"]){
                                                                                  coveragePoints["Register_file_62"] = true;
                                                                                  coveragePointsCount++;
                                                                                  std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_62\n";
                                                                                }
                                                                                ...
                                                                                if(!coveragePoints["Register_file_63"]){
                                                                                  ...
                                                                                  coveragePointsCount++;
                                                                                  std::cout<<"Coverage Percentage: Register_file " << ( coveragePointsCount * 100 /coveragePointsTotal ) << "%    ------    Register_file_63\n";
                                                                                }
