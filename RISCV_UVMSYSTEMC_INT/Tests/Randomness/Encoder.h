...
//        unsigned int constrained_imm = decodedinstr.G_imm % 2048;
//        unsigned int imm_1 = (constrained_imm & 0x000FF000) << 12;
//        unsigned int imm_2 = (constrained_imm & 0x00000800) << 20;
//        unsigned int imm_3 = (constrained_imm & 0x000007FE) << 21;
//        unsigned int imm_4 = (constrained_imm & 0x00100000) << 31;
        unsigned int imm_1 = (decodedinstr.G_imm & 0x000FF000) << 12;
        unsigned int imm_2 = (decodedinstr.G_imm & 0x00000800) << 20;
        unsigned int imm_3 = (decodedinstr.G_imm & 0x000007FE) << 21;
        unsigned int imm_4 = (decodedinstr.G_imm & 0x00100000) << 31;
