...
public:
    vip_sequencer<vip_trans_fromMemory, vip_trans_toMemory> *sequencer;
    vip_driver<vip_trans_fromMemory, vip_trans_toMemory> *driver;
    ...
    void build_phase(uvm_phase &phase) {
        uvm_agent::build_phase(phase);
            ...
            sequencer = vip_sequencer<vip_trans_fromMemory, vip_trans_toMemory>::type_id::create("sequencer", this);
            assert(sequencer);

            driver = vip_driver<vip_trans_fromMemory, vip_trans_toMemory>::type_id::create("driver", this);
            assert(driver);
    }
