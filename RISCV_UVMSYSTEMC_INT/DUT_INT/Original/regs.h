...
void Regs::run() {
    ...
    while (true) {
        ...
        // return current data for syscall
        regfileSyscall.reg_file_10 = reg_file_10;
        regfileSyscall.reg_file_11 = reg_file_11;
        regfileSyscall.reg_file_12 = reg_file_12;
        regfileSyscall.reg_file_17 = reg_file_17;
        ...
        rec = syscall_reg_Port->nb_read(regfileSyscallWrite); // read request from syscall
        if (rec) {
