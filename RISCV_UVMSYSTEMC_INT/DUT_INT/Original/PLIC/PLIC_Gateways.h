...
class PLIC_Gateways_PPA : public sc_module {
public:

    TheUNKNOWN_PPA sources;
    Gateway_PPA gateway_1;
    Gateway_PPA gateway_2;

    //Constructor
    SC_HAS_PROCESS(PLIC_Gateways_PPA);

    PLIC_Gateways_PPA(sc_module_name name) :
            sources("IntSources"),
            gateway_1("gateway_1"),
            gateway_2("gateway_2"),
            IntSig_1("IntSig_1"),
