          ...
          if ((((encodedInstr >> 25) & 127) == 0)) {
            ...
            if ((((encodedInstr >> 25) & 127) == 32)) {
              ...
              if(!coveragePoints["Control_unit_6"]){
                ...
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_6\n";
              }
              return(ALU_X);
            }
          }
                  ...
                  if ((((encodedInstr >> 12) & 7) == 5)) {
                    ...
                    if ((((encodedInstr >> 25) & 127) == 0)) {
                      ...
                      if(!coveragePoints["Control_unit_18"]){
                        ...
                        coveragePointsCount++;
                        std::cout<<"Coverage Percentage: Control_unit_18\n";
                      }
                      if ((((encodedInstr >> 25) & 127) == 32)) {
                        if(!coveragePoints["Control_unit_19"]){
                          coveragePoints["Control_unit_19"] = true;
                          coveragePointsCount++;
                          std::cout<<"Coverage Percentage: Control_unit_19\n";
                        }
                        return(ALU_SRA);
                      } else {
                        if(!coveragePoints["Control_unit_20"]){
                          ...
                          coveragePointsCount++;
                          std::cout<<"Coverage Percentage: Control_unit_20\n";
                        }
                        return(ALU_X);
                      }
                    }
                    ...
                    if ((((encodedInstr >> 12) & 7) == 6)) {
                      ...
                      if ((((encodedInstr >> 12) & 7) == 7)) {
                        ...
                        if(!coveragePoints["Control_unit_25"]){
                          ...
                          coveragePointsCount++;
                          std::cout<<"Coverage Percentage: Control_unit_25\n";
                        }
                        return(ALU_X);
                      }
                    }
        ...
        if (((encodedInstr & 127) == 19)) {
          ...
          if ((((encodedInstr >> 12) & 7) == 0)) {
            ...
            if(!coveragePoints["Control_unit_29"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_29\n";
            }
            if ((((encodedInstr >> 12) & 7) == 1)) {
              if(!coveragePoints["Control_unit_30"]){
                coveragePoints["Control_unit_30"] = true;
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_30\n";
              }
              return(ALU_SLL);
            } else {
              if(!coveragePoints["Control_unit_31"]){
                ...
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_31\n";
              }
              if ((((encodedInstr >> 12) & 7) == 2)) {
                if(!coveragePoints["Control_unit_32"]){
                  coveragePoints["Control_unit_32"] = true;
                  coveragePointsCount++;
                  std::cout<<"Coverage Percentage: Control_unit_32\n";
                }
                return(ALU_SLT);
              } else {
                if(!coveragePoints["Control_unit_33"]){
                  ...
                  coveragePointsCount++;
                  std::cout<<"Coverage Percentage: Control_unit_33\n";
                }
                if ((((encodedInstr >> 12) & 7) == 3)) {
                  if(!coveragePoints["Control_unit_34"]){
                    coveragePoints["Control_unit_34"] = true;
                    coveragePointsCount++;
                    std::cout<<"Coverage Percentage: Control_unit_34\n";
                  }
                  return(ALU_SLTU);
                } else {
                  if(!coveragePoints["Control_unit_35"]){
                    ...
                    coveragePointsCount++;
                    std::cout<<"Coverage Percentage: Control_unit_35\n";
                  }
                  if ((((encodedInstr >> 12) & 7) == 4)) {
                    if(!coveragePoints["Control_unit_36"]){
                      coveragePoints["Control_unit_36"] = true;
                      coveragePointsCount++;
                      std::cout<<"Coverage Percentage: Control_unit_36\n";
                    }
                    return(ALU_XOR);
                  } else {
                    ...
                    if ((((encodedInstr >> 12) & 7) == 5)) {
                      ...
                      if ((((encodedInstr >> 25) & 127) == 0)) {
                        ...
                        if(!coveragePoints["Control_unit_40"]){
                          ...
                          coveragePointsCount++;
                          std::cout<<"Coverage Percentage: Control_unit_40\n";
                        }
                        if ((((encodedInstr >> 25) & 127) == 32)) {
                          if(!coveragePoints["Control_unit_41"]){
                            coveragePoints["Control_unit_41"] = true;
                            coveragePointsCount++;
                            std::cout<<"Coverage Percentage: Control_unit_41\n";
                          }
                          return(ALU_SRA);
                        } else {
                          if(!coveragePoints["Control_unit_42"]){
                            ...
                            coveragePointsCount++;
                            std::cout<<"Coverage Percentage: Control_unit_42\n";
                          }
                          return(ALU_X);
                        }
                      }
                      ...
                      if(!coveragePoints["Control_unit_43"]){
                        ...
                        coveragePointsCount++;
                        std::cout<<"Coverage Percentage: Control_unit_43\n";
                      }
                      if ((((encodedInstr >> 12) & 7) == 6)) {
                        if(!coveragePoints["Control_unit_44"]){
                          coveragePoints["Control_unit_44"] = true;
                          coveragePointsCount++;
                          std::cout<<"Coverage Percentage: Control_unit_44\n";
                        }
                        return(ALU_OR);
                      } else {
                        if(!coveragePoints["Control_unit_45"]){
                          ...
                          coveragePointsCount++;
                          std::cout<<"Coverage Percentage: Control_unit_45\n";
                        }
                        if ((((encodedInstr >> 12) & 7) == 7)) {
                          if(!coveragePoints["Control_unit_46"]){
                            coveragePoints["Control_unit_46"] = true;
                            coveragePointsCount++;
                            std::cout<<"Coverage Percentage: Control_unit_46\n";
                          }
                          return(ALU_AND);
                        } else {
                          if(!coveragePoints["Control_unit_47"]){
                            ...
                            coveragePointsCount++;
                            std::cout<<"Coverage Percentage: Control_unit_47\n";
                          }
                          return(ALU_X);
                        }
                      }
              ...
              if (((encodedInstr & 127) == 55)) {
                ...
                if (((encodedInstr & 127) == 23)) {
                  ...
                  if(!coveragePoints["Control_unit_56"]){
                    ...
                    coveragePointsCount++;
                    std::cout<<"Coverage Percentage: Control_unit_56\n";
                  }
                  return(ALU_X);
                }
              }
    ...
    AL_OperandSelType getALUop1Sel(unsigned encodedInstr) {
      if ((((((encodedInstr & 127) == 51) or ((encodedInstr & 127) == 19)) or ((encodedInstr & 127) == 3)) or ((encodedInstr & 127) == 35))) {
        if(!coveragePoints["Control_unit_57"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_57\n";
        }
        return(OP_REG);
      } else {
        if(!coveragePoints["Control_unit_58"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_58\n";
        }
        if (((encodedInstr & 127) == 55)) {
          if(!coveragePoints["Control_unit_59"]){
            coveragePoints["Control_unit_59"] = true;
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_59\n";
          }
          return(OP_IMM);
        } else {
          if(!coveragePoints["Control_unit_60"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_60\n";
          }
          if (((encodedInstr & 127) == 23)) {
            if(!coveragePoints["Control_unit_61"]){
              coveragePoints["Control_unit_61"] = true;
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_61\n";
            }
            return(OP_PC);
          } else {
            if(!coveragePoints["Control_unit_62"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_62\n";
            }
            return(OP_X);
          }
        }
    ...
    AL_OperandSelType getALUop2Sel(unsigned encodedInstr) {
      if (((encodedInstr & 127) == 51)) {
        if(!coveragePoints["Control_unit_63"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_63\n";
        }
        return(OP_REG);
      } else {
        if(!coveragePoints["Control_unit_64"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_64\n";
        }
        if ((((((encodedInstr & 127) == 19) or ((encodedInstr & 127) == 3)) or ((encodedInstr & 127) == 35)) or ((encodedInstr & 127) == 23))) {
          if(!coveragePoints["Control_unit_65"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_65\n";
          }
          return(OP_IMM);
        } else {
          if(!coveragePoints["Control_unit_66"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_66\n";
          }
          return(OP_X);
        }
      }
    ...
    bool getBranchEvaluation(InstrType instrType, unsigned reg1Content, unsigned reg2Content) {
      if (((instrType == INSTR_BEQ) and ((reg1Content - reg2Content) == 0))) {
        if(!coveragePoints["Control_unit_67"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_67\n";
        }
        return(true);
      } else {
        ...
        if (((instrType == INSTR_BNE) and ((reg1Content - reg2Content) != 0))) {
          ...
          if(!coveragePoints["Control_unit_70"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_70\n";
          }
          if (((instrType == INSTR_BLT) and (static_cast<int>(reg1Content) < static_cast<int>(reg2Content)))) {
            if(!coveragePoints["Control_unit_71"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_71\n";
            }
            return(true);
          } else {
            if(!coveragePoints["Control_unit_72"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_72\n";
            }
            if (((instrType == INSTR_BGE) and (static_cast<int>(reg1Content) >= static_cast<int>(reg2Content)))) {
              if(!coveragePoints["Control_unit_73"]){
                ...
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_73\n";
              }
              return(true);
            } else {
              ...
              if (((instrType == INSTR_BLTU) and (reg1Content < reg2Content))) {
                ...
                if (((instrType == INSTR_BGEU) and (reg1Content >= reg2Content))) {
                  ...
                  if(!coveragePoints["Control_unit_78"]){
                    ...
                    coveragePointsCount++;
                    std::cout<<"Coverage Percentage: Control_unit_78\n";
                  }
                  return(false);
                }
              }
    ...
    ME_MaskType getDmemMask(unsigned encodedInstr) {
      if (((encodedInstr & 127) == 3)) {
        if(!coveragePoints["Control_unit_79"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_79\n";
        }
        if ((((encodedInstr >> 12) & 7) == 0)) {
          if(!coveragePoints["Control_unit_80"]){
            coveragePoints["Control_unit_80"] = true;
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_80\n";
          }
          return(MT_B);
        } else {
          if(!coveragePoints["Control_unit_81"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_81\n";
          }
          if ((((encodedInstr >> 12) & 7) == 1)) {
            if(!coveragePoints["Control_unit_82"]){
              coveragePoints["Control_unit_82"] = true;
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_82\n";
            }
            return(MT_H);
          } else {
            if(!coveragePoints["Control_unit_83"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_83\n";
            }
            if ((((encodedInstr >> 12) & 7) == 2)) {
              if(!coveragePoints["Control_unit_84"]){
                coveragePoints["Control_unit_84"] = true;
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_84\n";
              }
              return(MT_W);
            } else {
              if(!coveragePoints["Control_unit_85"]){
                ...
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_85\n";
              }
              if ((((encodedInstr >> 12) & 7) == 4)) {
                if(!coveragePoints["Control_unit_86"]){
                  coveragePoints["Control_unit_86"] = true;
                  coveragePointsCount++;
                  std::cout<<"Coverage Percentage: Control_unit_86\n";
                }
                return(MT_BU);
              } else {
                if(!coveragePoints["Control_unit_87"]){
                  ...
                  coveragePointsCount++;
                  std::cout<<"Coverage Percentage: Control_unit_87\n";
                }
                if ((((encodedInstr >> 12) & 7) == 5)) {
                  if(!coveragePoints["Control_unit_88"]){
                    coveragePoints["Control_unit_88"] = true;
                    coveragePointsCount++;
                    std::cout<<"Coverage Percentage: Control_unit_88\n";
                  }
                  return(MT_HU);
                } else {
                  if(!coveragePoints["Control_unit_89"]){
                    ...
                    coveragePointsCount++;
                    std::cout<<"Coverage Percentage: Control_unit_89\n";
                  }
                  return(MT_X);
                }
              }
        ...
        if (((encodedInstr & 127) == 35)) {
          ...
          if ((((encodedInstr >> 12) & 7) == 0)) {
            ...
            if(!coveragePoints["Control_unit_93"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_93\n";
            }
            if ((((encodedInstr >> 12) & 7) == 1)) {
              if(!coveragePoints["Control_unit_94"]){
                coveragePoints["Control_unit_94"] = true;
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_94\n";
              }
              return(MT_H);
            } else {
              if(!coveragePoints["Control_unit_95"]){
                ...
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_95\n";
              }
              if ((((encodedInstr >> 12) & 7) == 2)) {
                if(!coveragePoints["Control_unit_96"]){
                  coveragePoints["Control_unit_96"] = true;
                  coveragePointsCount++;
                  std::cout<<"Coverage Percentage: Control_unit_96\n";
                }
                return(MT_W);
              } else {
                if(!coveragePoints["Control_unit_97"]){
                  ...
                  coveragePointsCount++;
                  std::cout<<"Coverage Percentage: Control_unit_97\n";
                }
                return(MT_X);
              }
            }
          ...
          if(!coveragePoints["Control_unit_98"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_98\n";
          }
          return(MT_X);
        }
      }
    ...
    ME_AccessType getDmemReq(unsigned encodedInstr) {
      if (((encodedInstr & 127) == 3)) {
        if(!coveragePoints["Control_unit_99"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_99\n";
        }
        return(ME_RD);
      } else {
        if(!coveragePoints["Control_unit_100"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_100\n";
        }
        if (((encodedInstr & 127) == 35)) {
          if(!coveragePoints["Control_unit_101"]){
            coveragePoints["Control_unit_101"] = true;
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_101\n";
          }
          return(ME_WR);
        } else {
          if(!coveragePoints["Control_unit_102"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_102\n";
          }
          return(ME_X);
        }
      }
    ...
    EncType getEncType(unsigned encodedInstr) {
      if (((encodedInstr & 127) == 51)) {
        if(!coveragePoints["Control_unit_103"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_103\n";
        }
        return(ENC_R);
      } else {
        if(!coveragePoints["Control_unit_104"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_104\n";
        }
        if (((encodedInstr & 127) == 19)) {
          if(!coveragePoints["Control_unit_105"]){
            coveragePoints["Control_unit_105"] = true;
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_105\n";
          }
          return(ENC_I_I);
        } else {
          if(!coveragePoints["Control_unit_106"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_106\n";
          }
          if (((encodedInstr & 127) == 3)) {
            if(!coveragePoints["Control_unit_107"]){
              coveragePoints["Control_unit_107"] = true;
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_107\n";
            }
            return(ENC_I_L);
          } else {
            ...
            if (((encodedInstr & 127) == 103)) {
              ...
              if(!coveragePoints["Control_unit_110"]){
                ...
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_110\n";
              }
              if (((encodedInstr & 127) == 35)) {
                if(!coveragePoints["Control_unit_111"]){
                  coveragePoints["Control_unit_111"] = true;
                  coveragePointsCount++;
                  std::cout<<"Coverage Percentage: Control_unit_111\n";
                }
                return(ENC_S);
              } else {
                  ...
                  if ((((encodedInstr & 127) == 55) or ((encodedInstr & 127) == 23))) {
                    ...
                    if (((encodedInstr & 127) == 111)) {
                      ...
                      if(!coveragePoints["Control_unit_118"]){
                        ...
                        coveragePointsCount++;
                        std::cout<<"Coverage Percentage: Control_unit_118\n";
                      }
                      return(ENC_ERR);
                    }
                  }
      ...
      if (((encodedInstr & 127) == 103)) {
        ...
        if ((((encodedInstr >> 31) & 1) == 1)) {
          ...
          if(!coveragePoints["Control_unit_121"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_121\n";
          }
        ...
        if (((encodedInstr & 127) == 99)) {
          ...
          if ((((encodedInstr >> 31) & 1) == 1)) {
            ...
            if(!coveragePoints["Control_unit_125"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_125\n";
            }
          ...
          if (((encodedInstr & 127) == 111)) {
            ...
            if ((((encodedInstr >> 31) & 1) == 1)) {
              ...
              if(!coveragePoints["Control_unit_129"]){
                ...
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_129\n";
              }
            ...
            if(!coveragePoints["Control_unit_130"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_130\n";
            }
            return(0);
          }
        }
    ...
    unsigned getImmS5(unsigned encodedInstr) {
      if ((((encodedInstr & 127) == 19) or ((encodedInstr & 127) == 3))) {
        if(!coveragePoints["Control_unit_131"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_131\n";
        }
        if ((((encodedInstr >> 31) & 1) == 1)) {
          if(!coveragePoints["Control_unit_132"]){
            coveragePoints["Control_unit_132"] = true;
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_132\n";
          }
          return((static_cast<unsigned>(-4096) | (encodedInstr >> 20)));
        } else {
          if(!coveragePoints["Control_unit_133"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_133\n";
          }
          return((encodedInstr >> 20));
        }
      } else {
        ...
        if (((encodedInstr & 127) == 35)) {
          ...
          if ((((encodedInstr >> 31) & 1) == 1)) {
            ...
            if(!coveragePoints["Control_unit_137"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_137\n";
            }
          ...
          if(!coveragePoints["Control_unit_138"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_138\n";
          }
          if ((((encodedInstr & 127) == 55) or ((encodedInstr & 127) == 23))) {
            if(!coveragePoints["Control_unit_139"]){
              coveragePoints["Control_unit_139"] = true;
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_139\n";
            }
            ...
            if(!coveragePoints["Control_unit_140"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_140\n";
            }
            return(0);
          }
        }
        ...
        if ((((encodedInstr >> 12) & 7) == 0)) {
          ...
          if ((((encodedInstr >> 25) & 127) == 0)) {
            ...
            if(!coveragePoints["Control_unit_144"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_144\n";
            }
            if ((((encodedInstr >> 25) & 127) == 32)) {
              if(!coveragePoints["Control_unit_145"]){
                coveragePoints["Control_unit_145"] = true;
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_145\n";
              }
              return(INSTR_SUB);
            } else {
              if(!coveragePoints["Control_unit_146"]){
                ...
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_146\n";
              }
          ...
          if(!coveragePoints["Control_unit_147"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_147\n";
          }
          if ((((encodedInstr >> 12) & 7) == 1)) {
            if(!coveragePoints["Control_unit_148"]){
              coveragePoints["Control_unit_148"] = true;
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_148\n";
            }
            return(INSTR_SLL);
          } else {
            if(!coveragePoints["Control_unit_149"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_149\n";
            }
            if ((((encodedInstr >> 12) & 7) == 2)) {
              if(!coveragePoints["Control_unit_150"]){
                coveragePoints["Control_unit_150"] = true;
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_150\n";
              }
              return(INSTR_SLT);
            } else {
              if(!coveragePoints["Control_unit_151"]){
                ...
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_151\n";
              }
              if ((((encodedInstr >> 12) & 7) == 3)) {
                if(!coveragePoints["Control_unit_152"]){
                  coveragePoints["Control_unit_152"] = true;
                  coveragePointsCount++;
                  std::cout<<"Coverage Percentage: Control_unit_152\n";
                }
                return(INSTR_SLTU);
              } else {
                if(!coveragePoints["Control_unit_153"]){
                  ...
                  coveragePointsCount++;
                  std::cout<<"Coverage Percentage: Control_unit_153\n";
                }
                if ((((encodedInstr >> 12) & 7) == 4)) {
                  if(!coveragePoints["Control_unit_154"]){
                    coveragePoints["Control_unit_154"] = true;
                    coveragePointsCount++;
                    std::cout<<"Coverage Percentage: Control_unit_154\n";
                  }
                  return(INSTR_XOR);
                } else {
                  ...
                  if ((((encodedInstr >> 12) & 7) == 5)) {
                    ...
                    if ((((encodedInstr >> 25) & 127) == 0)) {
                      ...
                      if(!coveragePoints["Control_unit_158"]){
                        ...
                        coveragePointsCount++;
                        std::cout<<"Coverage Percentage: Control_unit_158\n";
                      }
                      if ((((encodedInstr >> 25) & 127) == 32)) {
                        if(!coveragePoints["Control_unit_159"]){
                          coveragePoints["Control_unit_159"] = true;
                          coveragePointsCount++;
                          std::cout<<"Coverage Percentage: Control_unit_159\n";
                        }
                        return(INSTR_SRA);
                      } else {
                        if(!coveragePoints["Control_unit_160"]){
                          ...
                          coveragePointsCount++;
                          std::cout<<"Coverage Percentage: Control_unit_160\n";
                        }
                        return(INSTR_UNKNOWN);
                      }
                    }
                    ...
                    if(!coveragePoints["Control_unit_161"]){
                      ...
                      coveragePointsCount++;
                      std::cout<<"Coverage Percentage: Control_unit_161\n";
                    }
                    if ((((encodedInstr >> 12) & 7) == 6)) {
                      if(!coveragePoints["Control_unit_162"]){
                        coveragePoints["Control_unit_162"] = true;
                        coveragePointsCount++;
                        std::cout<<"Coverage Percentage: Control_unit_162\n";
                      }
                      return(INSTR_OR);
                    } else {
                      if(!coveragePoints["Control_unit_163"]){
                        ...
                        coveragePointsCount++;
                        std::cout<<"Coverage Percentage: Control_unit_163\n";
                      }
                      if ((((encodedInstr >> 12) & 7) == 7)) {
                        if(!coveragePoints["Control_unit_164"]){
                          coveragePoints["Control_unit_164"] = true;
                          coveragePointsCount++;
                          std::cout<<"Coverage Percentage: Control_unit_164\n";
                        }
                        return(INSTR_AND);
                      } else {
                        if(!coveragePoints["Control_unit_165"]){
                          ...
                          coveragePointsCount++;
                          std::cout<<"Coverage Percentage: Control_unit_165\n";
                        }
                        return(INSTR_UNKNOWN);
                      }
                    }
        ...
        if (((encodedInstr & 127) == 19)) {
          ...
          if ((((encodedInstr >> 12) & 7) == 0)) {
            ...
            if(!coveragePoints["Control_unit_169"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_169\n";
            }
            if ((((encodedInstr >> 12) & 7) == 1)) {
              if(!coveragePoints["Control_unit_170"]){
                coveragePoints["Control_unit_170"] = true;
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_170\n";
              }
              return(INSTR_SLLI);
            } else {
              if(!coveragePoints["Control_unit_171"]){
                ...
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_171\n";
              }
              if ((((encodedInstr >> 12) & 7) == 2)) {
                if(!coveragePoints["Control_unit_172"]){
                  coveragePoints["Control_unit_172"] = true;
                  coveragePointsCount++;
                  std::cout<<"Coverage Percentage: Control_unit_172\n";
                }
                return(INSTR_SLTI);
              } else {
                if(!coveragePoints["Control_unit_173"]){
                  ...
                  coveragePointsCount++;
                  std::cout<<"Coverage Percentage: Control_unit_173\n";
                }
                if ((((encodedInstr >> 12) & 7) == 3)) {
                  if(!coveragePoints["Control_unit_174"]){
                    coveragePoints["Control_unit_174"] = true;
                    coveragePointsCount++;
                    std::cout<<"Coverage Percentage: Control_unit_174\n";
                  }
                  return(INSTR_SLTUI);
                } else {
                  if(!coveragePoints["Control_unit_175"]){
                    ...
                    coveragePointsCount++;
                    std::cout<<"Coverage Percentage: Control_unit_175\n";
                  }
                  if ((((encodedInstr >> 12) & 7) == 4)) {
                    if(!coveragePoints["Control_unit_176"]){
                      coveragePoints["Control_unit_176"] = true;
                      coveragePointsCount++;
                      std::cout<<"Coverage Percentage: Control_unit_176\n";
                    }
                    return(INSTR_XORI);
                  } else {
                    ...
                    if ((((encodedInstr >> 12) & 7) == 5)) {
                      ...
                      if ((((encodedInstr >> 25) & 127) == 0)) {
                        ...
                        if(!coveragePoints["Control_unit_180"]){
                          ...
                          coveragePointsCount++;
                          std::cout<<"Coverage Percentage: Control_unit_180\n";
                        }
                        if ((((encodedInstr >> 25) & 127) == 32)) {
                          if(!coveragePoints["Control_unit_181"]){
                            coveragePoints["Control_unit_181"] = true;
                            coveragePointsCount++;
                            std::cout<<"Coverage Percentage: Control_unit_181\n";
                          }
                          return(INSTR_SRAI);
                        } else {
                          if(!coveragePoints["Control_unit_182"]){
                            ...
                            coveragePointsCount++;
                            std::cout<<"Coverage Percentage: Control_unit_182\n";
                          }
                          return(INSTR_UNKNOWN);
                        }
                      }
                      ...
                      if(!coveragePoints["Control_unit_183"]){
                        ...
                        coveragePointsCount++;
                        std::cout<<"Coverage Percentage: Control_unit_183\n";
                      }
                      if ((((encodedInstr >> 12) & 7) == 6)) {
                        if(!coveragePoints["Control_unit_184"]){
                          coveragePoints["Control_unit_184"] = true;
                          coveragePointsCount++;
                          std::cout<<"Coverage Percentage: Control_unit_184\n";
                        }
                        return(INSTR_ORI);
                      } else {
                        if(!coveragePoints["Control_unit_185"]){
                          ...
                          coveragePointsCount++;
                          std::cout<<"Coverage Percentage: Control_unit_185\n";
                        }
                        if ((((encodedInstr >> 12) & 7) == 7)) {
                          if(!coveragePoints["Control_unit_186"]){
                            coveragePoints["Control_unit_186"] = true;
                            coveragePointsCount++;
                            std::cout<<"Coverage Percentage: Control_unit_186\n";
                          }
                          return(INSTR_ANDI);
                        } else {
                          if(!coveragePoints["Control_unit_187"]){
                            ...
                            coveragePointsCount++;
                            std::cout<<"Coverage Percentage: Control_unit_187\n";
                          }
                          return(INSTR_UNKNOWN);
                        }
                      }
          ...
          if (((encodedInstr & 127) == 3)) {
            ...
            if ((((encodedInstr >> 12) & 7) == 0)) {
              ...
              if(!coveragePoints["Control_unit_191"]){
                ...
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_191\n";
              }
              if ((((encodedInstr >> 12) & 7) == 1)) {
                if(!coveragePoints["Control_unit_192"]){
                  coveragePoints["Control_unit_192"] = true;
                  coveragePointsCount++;
                  std::cout<<"Coverage Percentage: Control_unit_192\n";
                }
                return(INSTR_LH);
              } else {
                if(!coveragePoints["Control_unit_193"]){
                  ...
                  coveragePointsCount++;
                  std::cout<<"Coverage Percentage: Control_unit_193\n";
                }
                if ((((encodedInstr >> 12) & 7) == 2)) {
                  if(!coveragePoints["Control_unit_194"]){
                    coveragePoints["Control_unit_194"] = true;
                    coveragePointsCount++;
                    std::cout<<"Coverage Percentage: Control_unit_194\n";
                  }
                  return(INSTR_LW);
                } else {
                  if(!coveragePoints["Control_unit_195"]){
                    ...
                    coveragePointsCount++;
                    std::cout<<"Coverage Percentage: Control_unit_195\n";
                  }
                  if ((((encodedInstr >> 12) & 7) == 4)) {
                    if(!coveragePoints["Control_unit_196"]){
                      coveragePoints["Control_unit_196"] = true;
                      coveragePointsCount++;
                      std::cout<<"Coverage Percentage: Control_unit_196\n";
                    }
                    return(INSTR_LBU);
                  } else {
                    if(!coveragePoints["Control_unit_197"]){
                      ...
                      coveragePointsCount++;
                      std::cout<<"Coverage Percentage: Control_unit_197\n";
                    }
                    if ((((encodedInstr >> 12) & 7) == 5)) {
                      if(!coveragePoints["Control_unit_198"]){
                        coveragePoints["Control_unit_198"] = true;
                        coveragePointsCount++;
                        std::cout<<"Coverage Percentage: Control_unit_198\n";
                      }
                      return(INSTR_LHU);
                    } else {
                      if(!coveragePoints["Control_unit_199"]){
                        ...
                        coveragePointsCount++;
                        std::cout<<"Coverage Percentage: Control_unit_199\n";
                      }
                      return(INSTR_UNKNOWN);
                    }
                  }
            ...
            if(!coveragePoints["Control_unit_200"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_200\n";
            }
            if (((encodedInstr & 127) == 103)) {
              if(!coveragePoints["Control_unit_201"]){
                coveragePoints["Control_unit_201"] = true;
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_201\n";
              }
              return(INSTR_JALR);
            } else {
              ...
              if (((encodedInstr & 127) == 35)) {
                ...
                if ((((encodedInstr >> 12) & 7) == 0)) {
                  ...
                  if(!coveragePoints["Control_unit_205"]){
                    ...
                    coveragePointsCount++;
                    std::cout<<"Coverage Percentage: Control_unit_205\n";
                  }
                  if ((((encodedInstr >> 12) & 7) == 1)) {
                    if(!coveragePoints["Control_unit_206"]){
                      coveragePoints["Control_unit_206"] = true;
                      coveragePointsCount++;
                      std::cout<<"Coverage Percentage: Control_unit_206\n";
                    }
                    return(INSTR_SH);
                  } else {
                    if(!coveragePoints["Control_unit_207"]){
                      ...
                      coveragePointsCount++;
                      std::cout<<"Coverage Percentage: Control_unit_207\n";
                    }
                    if ((((encodedInstr >> 12) & 7) == 2)) {
                      if(!coveragePoints["Control_unit_208"]){
                        coveragePoints["Control_unit_208"] = true;
                        coveragePointsCount++;
                        std::cout<<"Coverage Percentage: Control_unit_208\n";
                      }
                      return(INSTR_SW);
                    } else {
                      if(!coveragePoints["Control_unit_209"]){
                        ...
                        coveragePointsCount++;
                        std::cout<<"Coverage Percentage: Control_unit_209\n";
                      }
                      return(INSTR_UNKNOWN);
                    }
                  }
                ...
                if (((encodedInstr & 127) == 99)) {
                  ...
                  if ((((encodedInstr >> 12) & 7) == 0)) {
                    ...
                    if(!coveragePoints["Control_unit_213"]){
                      ...
                      coveragePointsCount++;
                      std::cout<<"Coverage Percentage: Control_unit_213\n";
                    }
                    if ((((encodedInstr >> 12) & 7) == 1)) {
                      if(!coveragePoints["Control_unit_214"]){
                        coveragePoints["Control_unit_214"] = true;
                        coveragePointsCount++;
                        std::cout<<"Coverage Percentage: Control_unit_214\n";
                      }
                      return(INSTR_BNE);
                    } else {
                      if(!coveragePoints["Control_unit_215"]){
                        ...
                        coveragePointsCount++;
                        std::cout<<"Coverage Percentage: Control_unit_215\n";
                      }
                      if ((((encodedInstr >> 12) & 7) == 4)) {
                        if(!coveragePoints["Control_unit_216"]){
                          coveragePoints["Control_unit_216"] = true;
                          coveragePointsCount++;
                          std::cout<<"Coverage Percentage: Control_unit_216\n";
                        }
                        return(INSTR_BLT);
                      } else {
                        if(!coveragePoints["Control_unit_217"]){
                          ...
                          coveragePointsCount++;
                          std::cout<<"Coverage Percentage: Control_unit_217\n";
                        }
                        if ((((encodedInstr >> 12) & 7) == 5)) {
                          if(!coveragePoints["Control_unit_218"]){
                            coveragePoints["Control_unit_218"] = true;
                            coveragePointsCount++;
                            std::cout<<"Coverage Percentage: Control_unit_218\n";
                          }
                          return(INSTR_BGE);
                        } else {
                          if(!coveragePoints["Control_unit_219"]){
                            ...
                            coveragePointsCount++;
                            std::cout<<"Coverage Percentage: Control_unit_219\n";
                          }
                          if ((((encodedInstr >> 12) & 7) == 6)) {
                            if(!coveragePoints["Control_unit_220"]){
                              coveragePoints["Control_unit_220"] = true;
                              coveragePointsCount++;
                              std::cout<<"Coverage Percentage: Control_unit_220\n";
                            }
                            return(INSTR_BLTU);
                          } else {
                            if(!coveragePoints["Control_unit_221"]){
                              ...
                              coveragePointsCount++;
                              std::cout<<"Coverage Percentage: Control_unit_221\n";
                            }
                            if ((((encodedInstr >> 12) & 7) == 7)) {
                              if(!coveragePoints["Control_unit_222"]){
                                coveragePoints["Control_unit_222"] = true;
                                coveragePointsCount++;
                                std::cout<<"Coverage Percentage: Control_unit_222\n";
                              }
                              return(INSTR_BGEU);
                            } else {
                              if(!coveragePoints["Control_unit_223"]){
                                ...
                                coveragePointsCount++;
                                std::cout<<"Coverage Percentage: Control_unit_223\n";
                              }
                              return(INSTR_UNKNOWN);
                            }
                          }
                  ...
                  if(!coveragePoints["Control_unit_224"]){
                    ...
                    coveragePointsCount++;
                    std::cout<<"Coverage Percentage: Control_unit_224\n";
                  }
                  if (((encodedInstr & 127) == 55)) {
                    if(!coveragePoints["Control_unit_225"]){
                      coveragePoints["Control_unit_225"] = true;
                      coveragePointsCount++;
                      std::cout<<"Coverage Percentage: Control_unit_225\n";
                    }
                    return(INSTR_LUI);
                  } else {
                    if(!coveragePoints["Control_unit_226"]){
                      ...
                      coveragePointsCount++;
                      std::cout<<"Coverage Percentage: Control_unit_226\n";
                    }
                    if (((encodedInstr & 127) == 23)) {
                      if(!coveragePoints["Control_unit_227"]){
                        coveragePoints["Control_unit_227"] = true;
                        coveragePointsCount++;
                        std::cout<<"Coverage Percentage: Control_unit_227\n";
                      }
                      return(INSTR_AUIPC);
                    } else {
                      if(!coveragePoints["Control_unit_228"]){
                        ...
                        coveragePointsCount++;
                        std::cout<<"Coverage Percentage: Control_unit_228\n";
                      }
                      if (((encodedInstr & 127) == 111)) {
                        if(!coveragePoints["Control_unit_229"]){
                          coveragePoints["Control_unit_229"] = true;
                          coveragePointsCount++;
                          std::cout<<"Coverage Percentage: Control_unit_229\n";
                        }
                        return(INSTR_JAL);
                      } else {
                        if(!coveragePoints["Control_unit_230"]){
                          ...
                          coveragePointsCount++;
                          std::cout<<"Coverage Percentage: Control_unit_230\n";
                        }
                        return(INSTR_UNKNOWN);
                      }
                    }
    ...
    unsigned getPC(bool branchTaken, unsigned imm, unsigned pcReg, PC_SelType pcSel, unsigned reg1Content) {
      if ((pcSel == PC_BR)) {
        if(!coveragePoints["Control_unit_231"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_231\n";
        }
        if (branchTaken) {
          if(!coveragePoints["Control_unit_232"]){
            coveragePoints["Control_unit_232"] = true;
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_232\n";
          }
          return(((pcReg - 8) + imm));
        } else {
          if(!coveragePoints["Control_unit_233"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_233\n";
          }
          return((pcReg + 4));
        }
      } else {
        if(!coveragePoints["Control_unit_234"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_234\n";
        }
        if ((pcSel == PC_J)) {
          if(!coveragePoints["Control_unit_235"]){
            coveragePoints["Control_unit_235"] = true;
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_235\n";
          }
          return(((pcReg - 4) + imm));
        } else {
          if(!coveragePoints["Control_unit_236"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_236\n";
          }
          if ((pcSel == PC_JR)) {
            if(!coveragePoints["Control_unit_237"]){
              coveragePoints["Control_unit_237"] = true;
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_237\n";
            }
            ...
            if(!coveragePoints["Control_unit_238"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_238\n";
            }
            return((pcReg + 4));
          }
        }
    ...
    PC_SelType getPCsel(unsigned encodedInstr) {
      if ((((((((encodedInstr & 127) == 51) or ((encodedInstr & 127) == 19)) or ((encodedInstr & 127) == 3)) or ((encodedInstr & 127) == 35)) or ((encodedInstr & 127) == 55)) or ((encodedInstr & 127) == 23))) {
        if(!coveragePoints["Control_unit_239"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_239\n";
        }
        return(PC_4);
      } else {
        if(!coveragePoints["Control_unit_240"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_240\n";
        }
        if (((encodedInstr & 127) == 103)) {
          if(!coveragePoints["Control_unit_241"]){
            coveragePoints["Control_unit_241"] = true;
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_241\n";
          }
          return(PC_JR);
        } else {
          if(!coveragePoints["Control_unit_242"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_242\n";
          }
          if (((encodedInstr & 127) == 99)) {
            if(!coveragePoints["Control_unit_243"]){
              coveragePoints["Control_unit_243"] = true;
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_243\n";
            }
            return(PC_BR);
          } else {
            if(!coveragePoints["Control_unit_244"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_244\n";
            }
            if (((encodedInstr & 127) == 111)) {
              if(!coveragePoints["Control_unit_245"]){
                coveragePoints["Control_unit_245"] = true;
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_245\n";
              }
              return(PC_J);
            } else {
              if(!coveragePoints["Control_unit_246"]){
                ...
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_246\n";
              }
              return(PC_4);
            }
          }
    ...
    RF_RD_AccessType getRegFileReqS2(unsigned encodedInstr) {
      if ((((((((encodedInstr & 127) == 51) or ((encodedInstr & 127) == 19)) or ((encodedInstr & 127) == 3)) or ((encodedInstr & 127) == 103)) or ((encodedInstr & 127) == 35)) or ((encodedInstr & 127) == 99))) {
        if(!coveragePoints["Control_unit_247"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_247\n";
        }
        return(RF_RD);
      } else {
        if(!coveragePoints["Control_unit_248"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_248\n";
        }
        return(RF_RD_X);
      }
    }
    ...
    RF_WR_AccessType getRegFileReqS5(unsigned encodedInstr) {
      if (((((((((encodedInstr & 127) == 51) or ((encodedInstr & 127) == 19)) or ((encodedInstr & 127) == 3)) or ((encodedInstr & 127) == 103)) or ((encodedInstr & 127) == 55)) or ((encodedInstr & 127) == 23)) or ((encodedInstr & 127) == 111))) {
        if(!coveragePoints["Control_unit_249"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_249\n";
        }
        return(RF_WR);
      } else {
        if(!coveragePoints["Control_unit_250"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_250\n";
        }
        return(RF_WR_X);
      }
    }
    ...
    RF_WriteDataSelType getRegFileWriteDataSel(unsigned encodedInstr) {
      if ((((((encodedInstr & 127) == 51) or ((encodedInstr & 127) == 19)) or ((encodedInstr & 127) == 55)) or ((encodedInstr & 127) == 23))) {
        if(!coveragePoints["Control_unit_251"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_251\n";
        }
        return(WB_ALU);
      } else {
        if(!coveragePoints["Control_unit_252"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_252\n";
        }
        if (((encodedInstr & 127) == 3)) {
          if(!coveragePoints["Control_unit_253"]){
            coveragePoints["Control_unit_253"] = true;
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_253\n";
          }
          return(WB_MEM);
        } else {
          ...
          if ((((encodedInstr & 127) == 103) or ((encodedInstr & 127) == 111))) {
            ...
            if(!coveragePoints["Control_unit_256"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_256\n";
            }
            return(WB_X);
          }
        }
    ...
    unsigned getRegRdAddr(unsigned encodedInstr) {
      if (((((((((encodedInstr & 127) == 51) or ((encodedInstr & 127) == 19)) or ((encodedInstr & 127) == 3)) or ((encodedInstr & 127) == 103)) or ((encodedInstr & 127) == 55)) or ((encodedInstr & 127) == 23)) or ((encodedInstr & 127) == 111))) {
        if(!coveragePoints["Control_unit_257"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_257\n";
        }
        ...
        if(!coveragePoints["Control_unit_258"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_258\n";
        }
        return(0);
      }
    }
    ...
    unsigned getRegRs1Addr(unsigned encodedInstr) {
      if ((((((((encodedInstr & 127) == 51) or ((encodedInstr & 127) == 19)) or ((encodedInstr & 127) == 3)) or ((encodedInstr & 127) == 103)) or ((encodedInstr & 127) == 35)) or ((encodedInstr & 127) == 99))) {
        if(!coveragePoints["Control_unit_259"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_259\n";
        }
        ...
        if(!coveragePoints["Control_unit_260"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_260\n";
        }
        return(0);
      }
    }
    ...
    unsigned getRegRs2Addr(unsigned encodedInstr) {
      if (((((encodedInstr & 127) == 51) or ((encodedInstr & 127) == 35)) or ((encodedInstr & 127) == 99))) {
        if(!coveragePoints["Control_unit_261"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_261\n";
        }
        ...
        if(!coveragePoints["Control_unit_262"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_262\n";
        }
        return(0);
      }
    }
    ...
    bool getStallOnce(EncType currEncType, EncType prevEncType, unsigned regRdAddr, unsigned regRs1Addr, unsigned regRs2Addr) {
      if (((((currEncType == ENC_B) and (((prevEncType == ENC_R) or (prevEncType == ENC_I_I)) or (prevEncType == ENC_U))) or ((currEncType == ENC_R) and (prevEncType == ENC_I_L))) and ((regRs1Addr == regRdAddr) or (regRs2Addr == regRdAddr)))) {
        if(!coveragePoints["Control_unit_263"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_263\n";
        }
        return(true);
      } else {
        if(!coveragePoints["Control_unit_264"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_264\n";
        }
        if (((((((currEncType == ENC_I_I) or (currEncType == ENC_I_L)) or (currEncType == ENC_S)) and (prevEncType == ENC_I_L)) or ((currEncType == ENC_I_J) and (((prevEncType == ENC_R) or (prevEncType == ENC_I_I)) or (prevEncType == ENC_U)))) and (regRs1Addr == regRdAddr))) {
          if(!coveragePoints["Control_unit_265"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_265\n";
          }
          return(true);
        } else {
          if(!coveragePoints["Control_unit_266"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_266\n";
          }
          return(false);
        }
      }
    ...
    bool getStallTwice(EncType currEncType, EncType prevEncType, unsigned regRdAddr, unsigned regRs1Addr, unsigned regRs2Addr) {
      if ((((currEncType == ENC_B) and (prevEncType == ENC_I_L)) and ((regRs1Addr == regRdAddr) or (regRs2Addr == regRdAddr)))) {
        if(!coveragePoints["Control_unit_267"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_267\n";
        }
        return(true);
      } else {
        if(!coveragePoints["Control_unit_268"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Control_unit_268\n";
        }
        if ((((currEncType == ENC_I_J) and (prevEncType == ENC_I_L)) and (regRs1Addr == regRdAddr))) {
          if(!coveragePoints["Control_unit_269"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_269\n";
          }
          return(true);
        } else {
          if(!coveragePoints["Control_unit_270"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_270\n";
          }
          return(false);
        }
      }
      ...
      while(true) {
        if (section==decodeInstr) {
          if(!coveragePoints["Control_unit_271"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_271\n";
          }
          if (not(stall)) {
            if(!coveragePoints["Control_unit_272"]){
              coveragePoints["Control_unit_272"] = true;
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_272\n";
            }
          ...
          if(!coveragePoints["Control_unit_273"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_273\n";
          }
          if (dmemAccess) {
            if(!coveragePoints["Control_unit_274"]){
              coveragePoints["Control_unit_274"] = true;
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_274\n";
            }
            ...
            if(!coveragePoints["Control_unit_275"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_275\n";
            }
          ...
          if (dmemAccess) {
            if(!coveragePoints["Control_unit_276"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_276\n";
            }
            ...
            if(!coveragePoints["Control_unit_277"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_277\n";
            }
          ...
          if(!coveragePoints["Control_unit_278"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_278\n";
          }
          if (dmemAccess) {
            if(!coveragePoints["Control_unit_279"]){
              coveragePoints["Control_unit_279"] = true;
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_279\n";
            }
            ...
            if(!coveragePoints["Control_unit_280"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_280\n";
            }
          ...
          if (flushDmemAccess) {
            if(!coveragePoints["Control_unit_281"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_281\n";
            }
            ...
            if(!coveragePoints["Control_unit_282"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_282\n";
            }
          ...
          if ((((CUtoDP_data.encType_s2 == ENC_J) and CUtoDP_data.stallDmemAccess) or (flush and (CUtoDP_data.stallDmemAccess or dmemAccess)))) {
            if(!coveragePoints["Control_unit_283"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_283\n";
            }
            ...
            if(!coveragePoints["Control_unit_284"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_284\n";
            }
          ...
          if ((((((((currBranchTaken or flushDmemAccessTemp) or flush) or CUtoDP_data.stallDmemAccess) or stallOnce) or stallTwice) or (CUtoDP_data.encType_s2 == ENC_J)) or (CUtoDP_data.encType_s2 == ENC_I_J))) {
            if(!coveragePoints["Control_unit_285"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_285\n";
            }
            currPCsel = PC_4;
            currPCimm = 0;
            ...
            if(!coveragePoints["Control_unit_286"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_286\n";
            }
          ...
          if (CUtoDP_data.stallDmemAccess) {
            ...
            if(!coveragePoints["Control_unit_289"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_289\n";
            }
            dmemAccess = false;
          }
          if ((((CUtoDP_data.dmemReq_s4 == ME_RD) or (CUtoDP_data.dmemReq_s4 == ME_WR)) and not(dmemAccess))) {
            if(!coveragePoints["Control_unit_290"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_290\n";
            }
            ...
            if(!coveragePoints["Control_unit_291"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_291\n";
            }
          ...
          if ((dmemAccess and stallTwice)) {
            if(!coveragePoints["Control_unit_292"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_292\n";
            }
            stallTwice = true;
            stallOnce = false;
          } else {
            ...
            if ((dmemAccess and stallOnce)) {
              ...
              if(!coveragePoints["Control_unit_295"]){
                ...
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_295\n";
              }
              if (stallTwice) {
                if(!coveragePoints["Control_unit_296"]){
                  coveragePoints["Control_unit_296"] = true;
                  coveragePointsCount++;
                  std::cout<<"Coverage Percentage: Control_unit_296\n";
                }
                stallOnce = true;
                stallTwice = false;
              } else {
                if(!coveragePoints["Control_unit_297"]){
                  ...
                  coveragePointsCount++;
                  std::cout<<"Coverage Percentage: Control_unit_297\n";
                }
                stallOnce = false;
                stallTwice = false;
              }
          ...
          if(!coveragePoints["Control_unit_300"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_300\n";
          }
          ...
          if ((flush and dmemAccess)) {
            if(!coveragePoints["Control_unit_301"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_301\n";
            }
            ...
            if(!coveragePoints["Control_unit_302"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_302\n";
            }
          ...
          if ((not(stall) and (CUtoDP_data.regRdAddr_s2 != 0))) {
            if(!coveragePoints["Control_unit_303"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_303\n";
            }
          ...
          if (((((not(stallOnce) and not(stallTwice)) and (CUtoDP_data.encType_s2 != ENC_J)) and (CUtoDP_data.encType_s2 != ENC_I_J)) and not(currBranchTaken))) {
            if(!coveragePoints["Control_unit_304"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_304\n";
            }
            if ((((((DEtoCU_data.encType_s2 == ENC_I_J) and (encType_prev2 == ENC_I_L)) and (DEtoCU_data.regRs1Addr_s2 == regRdAddr_prev2)) and (regRdAddr_prev2 != 0)) or ((((DEtoCU_data.encType_s2 == ENC_B) and (encType_prev2 == ENC_I_L)) and ((DEtoCU_data.regRs1Addr_s2 == regRdAddr_prev2) or (DEtoCU_data.regRs2Addr_s2 == regRdAddr_prev2))) and (regRdAddr_prev2 != 0)))) {
              if(!coveragePoints["Control_unit_305"]){
                ...
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_305\n";
              }
              stallOnce = true;
            } else {
              if(!coveragePoints["Control_unit_306"]){
                ...
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_306\n";
              }
              if ((prevDmemAccess and (((((DEtoCU_data.encType_s2 == ENC_I_J) and (encType_prev3 == ENC_I_L)) and (DEtoCU_data.regRs1Addr_s2 == regRdAddr_prev3)) and (regRdAddr_prev3 != 0)) or ((((DEtoCU_data.encType_s2 == ENC_B) and (encType_prev3 == ENC_I_L)) and ((DEtoCU_data.regRs1Addr_s2 == regRdAddr_prev3) or (DEtoCU_data.regRs2Addr_s2 == regRdAddr_prev3))) and (regRdAddr_prev3 != 0))))) {
                if(!coveragePoints["Control_unit_307"]){
                  ...
                  coveragePointsCount++;
                  std::cout<<"Coverage Percentage: Control_unit_307\n";
                }
                stallOnce = true;
              } else {
                if(!coveragePoints["Control_unit_308"]){
                  ...
                  coveragePointsCount++;
                  std::cout<<"Coverage Percentage: Control_unit_308\n";
                }
                stallOnce = false;
              }
            }
          ...
          if(!coveragePoints["Control_unit_309"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Control_unit_309\n";
          }
          if (((CUtoDP_data.stallDmemAccess or stallOnce) or stallTwice)) {
            if(!coveragePoints["Control_unit_310"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_310\n";
            }
            stall = true;
          } else {
            if(!coveragePoints["Control_unit_311"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_311\n";
            }
            stall = false;
          }
          if ((prevJalrInstr or currBranchTaken)) {
            if(!coveragePoints["Control_unit_312"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_312\n";
            }
            flush = true;
            ...
            if(!coveragePoints["Control_unit_313"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_313\n";
            }
            flush = false;
            prevReg1Content = 0;
          }
          if (((CUtoDP_data.encType_s2 == ENC_I_J) or (CUtoDP_data.encType_s2 == ENC_B))) {
            if(!coveragePoints["Control_unit_314"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_314\n";
            }
            ...
            if ((CUtoDP_data.encType_s2 == ENC_I_J)) {
              if(!coveragePoints["Control_unit_315"]){
                ...
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_315\n";
              }
              prevJalrInstr = true;
            } else {
              if(!coveragePoints["Control_unit_316"]){
                ...
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Control_unit_316\n";
              }
              prevJalrInstr = false;
            }
          } else {
            if(!coveragePoints["Control_unit_317"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_317\n";
            }
            prevJalrInstr = false;
          }
          if (not(stall)) {
            if(!coveragePoints["Control_unit_318"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Control_unit_318\n";
            }
