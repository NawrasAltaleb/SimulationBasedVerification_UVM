    ...
    unsigned aluOpFwdUnit(unsigned aluResult_s4, unsigned dstAddr_s4, unsigned dstAddr_s5, EncType encType_s5, unsigned loadedData, unsigned regContent_s3, unsigned srcAddr_s3) {
      if (((((srcAddr_s3 == dstAddr_s5) and (encType_s5 == ENC_I_L)) and (srcAddr_s3 != dstAddr_s4)) and (srcAddr_s3 != 0))) {
        if(!coveragePoints["Data_path_1"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Data_path_1\n";
        }
        return(loadedData);
      } else {
        ...
        if (((srcAddr_s3 == dstAddr_s4) and (srcAddr_s3 != 0))) {
          ...
          if(!coveragePoints["Data_path_4"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Data_path_4\n";
          }
    ...
    unsigned dmemDataInFwdUnit(unsigned aluResult_s5, unsigned dstAddr_s5, EncType encType_s5, bool fwdPrevLoadedData, unsigned loadedData, unsigned prevLoadedData, unsigned reg2Content_s4, unsigned src2Addr_s4) {
      if ((((src2Addr_s4 == dstAddr_s5) and (encType_s5 == ENC_I_L)) and (src2Addr_s4 != 0))) {
        if(!coveragePoints["Data_path_5"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Data_path_5\n";
        }
        return(loadedData);
      } else {
        ...
        if (((src2Addr_s4 == dstAddr_s5) and (src2Addr_s4 != 0))) {
          ...
          if(!coveragePoints["Data_path_8"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Data_path_8\n";
          }
          if (fwdPrevLoadedData) {
            if(!coveragePoints["Data_path_9"]){
              coveragePoints["Data_path_9"] = true;
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Data_path_9\n";
            }
            ...
            if(!coveragePoints["Data_path_10"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Data_path_10\n";
            }
    ...
    unsigned getALUoperand(unsigned aluOpFwdUnitValue, AL_OperandSelType aluOpSel_s3, unsigned imm_s3, unsigned pc_s3) {
      if ((aluOpSel_s3 == OP_REG)) {
        if(!coveragePoints["Data_path_11"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Data_path_11\n";
        }
        ...
        if ((aluOpSel_s3 == OP_IMM)) {
          ...
          if(!coveragePoints["Data_path_14"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Data_path_14\n";
          }
          if ((aluOpSel_s3 == OP_PC)) {
            if(!coveragePoints["Data_path_15"]){
              coveragePoints["Data_path_15"] = true;
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Data_path_15\n";
            }
            return(pc_s3);
          } else {
            if(!coveragePoints["Data_path_16"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Data_path_16\n";
            }
            return(0);
          }
        }
    ...
    unsigned getALUresult(DPtoAL_IF DPtoAL_data) {
      if ((DPtoAL_data.aluFunc == ALU_ADD)) {
        if(!coveragePoints["Data_path_17"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Data_path_17\n";
        }
                ...
                if ((DPtoAL_data.aluFunc == ALU_SLT)) {
                  ...
                  if ((static_cast<int>(DPtoAL_data.aluOp1) < static_cast<int>(DPtoAL_data.aluOp2))) {
                    if(!coveragePoints["Data_path_28"]){
                      ...
                      coveragePointsCount++;
                      std::cout<<"Coverage Percentage: Data_path_28\n";
                    }
                    return(1);
                  } else {
                    if(!coveragePoints["Data_path_29"]){
                      ...
                      coveragePointsCount++;
                      std::cout<<"Coverage Percentage: Data_path_29\n";
                    }
                    return(0);
                  }
                } else {
                  ...
                  if ((DPtoAL_data.aluFunc == ALU_SLTU)) {
                    ...
                    if ((DPtoAL_data.aluOp1 < DPtoAL_data.aluOp2)) {
                      ...
                      if(!coveragePoints["Data_path_33"]){
                        ...
                        coveragePointsCount++;
                        std::cout<<"Coverage Percentage: Data_path_33\n";
                      }
                      return(0);
                    }
                  } else {
                        ...
                        if ((DPtoAL_data.aluFunc == ALU_SRL)) {
                          ...
                          if ((DPtoAL_data.aluFunc == ALU_COPY1)) {
                            ...
                            if(!coveragePoints["Data_path_42"]){
                              ...
                              coveragePointsCount++;
                              std::cout<<"Coverage Percentage: Data_path_42\n";
                            }
                            return(0);
                          }
                        }
    ...
    unsigned getRegContent(RFtoDP_IF RFtoDP_data, RF_RD_AccessType rdReq, unsigned srcAddr) {
      if ((rdReq == RF_RD)) {
        if(!coveragePoints["Data_path_43"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Data_path_43\n";
        }
        if ((srcAddr == 0)) {
          if(!coveragePoints["Data_path_44"]){
            coveragePoints["Data_path_44"] = true;
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Data_path_44\n";
          }
          return(0);
        } else {
          if(!coveragePoints["Data_path_45"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Data_path_45\n";
          }
          if ((srcAddr == 1)) {
            if(!coveragePoints["Data_path_46"]){
              coveragePoints["Data_path_46"] = true;
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Data_path_46\n";
            }
            ...
            if(!coveragePoints["Data_path_47"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Data_path_47\n";
            }
            if ((srcAddr == 2)) {
              if(!coveragePoints["Data_path_48"]){
                coveragePoints["Data_path_48"] = true;
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Data_path_48\n";
              }
              ...
              if(!coveragePoints["Data_path_49"]){
                ...
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Data_path_49\n";
              }
              if ((srcAddr == 3)) {
                if(!coveragePoints["Data_path_50"]){
                  coveragePoints["Data_path_50"] = true;
                  coveragePointsCount++;
                  std::cout<<"Coverage Percentage: Data_path_50\n";
                }
                ...
                if(!coveragePoints["Data_path_51"]){
                  ...
                  coveragePointsCount++;
                  std::cout<<"Coverage Percentage: Data_path_51\n";
                }
                if ((srcAddr == 4)) {
                  if(!coveragePoints["Data_path_52"]){
                    coveragePoints["Data_path_52"] = true;
                    coveragePointsCount++;
                    std::cout<<"Coverage Percentage: Data_path_52\n";
                  }
                  ...
                  if(!coveragePoints["Data_path_53"]){
                    ...
                    coveragePointsCount++;
                    std::cout<<"Coverage Percentage: Data_path_53\n";
                  }
                  if ((srcAddr == 5)) {
                    if(!coveragePoints["Data_path_54"]){
                      coveragePoints["Data_path_54"] = true;
                      coveragePointsCount++;
                      std::cout<<"Coverage Percentage: Data_path_54\n";
                    }
                    ...
                    if(!coveragePoints["Data_path_55"]){
                      ...
                      coveragePointsCount++;
                      std::cout<<"Coverage Percentage: Data_path_55\n";
                    }
                    if ((srcAddr == 6)) {
                      if(!coveragePoints["Data_path_56"]){
                        coveragePoints["Data_path_56"] = true;
                        coveragePointsCount++;
                        std::cout<<"Coverage Percentage: Data_path_56\n";
                      }
                      ...
                      if(!coveragePoints["Data_path_57"]){
                        ...
                        coveragePointsCount++;
                        std::cout<<"Coverage Percentage: Data_path_57\n";
                      }
                      if ((srcAddr == 7)) {
                        if(!coveragePoints["Data_path_58"]){
                          coveragePoints["Data_path_58"] = true;
                          coveragePointsCount++;
                          std::cout<<"Coverage Percentage: Data_path_58\n";
                        }
                        ...
                        if(!coveragePoints["Data_path_59"]){
                          ...
                          coveragePointsCount++;
                          std::cout<<"Coverage Percentage: Data_path_59\n";
                        }
                        if ((srcAddr == 8)) {
                          if(!coveragePoints["Data_path_60"]){
                            coveragePoints["Data_path_60"] = true;
                            coveragePointsCount++;
                            std::cout<<"Coverage Percentage: Data_path_60\n";
                          }
                          ...
                          if(!coveragePoints["Data_path_61"]){
                            ...
                            coveragePointsCount++;
                            std::cout<<"Coverage Percentage: Data_path_61\n";
                          }
                          if ((srcAddr == 9)) {
                            if(!coveragePoints["Data_path_62"]){
                              coveragePoints["Data_path_62"] = true;
                              coveragePointsCount++;
                              std::cout<<"Coverage Percentage: Data_path_62\n";
                            }
                            ...
                            if(!coveragePoints["Data_path_63"]){
                              ...
                              coveragePointsCount++;
                              std::cout<<"Coverage Percentage: Data_path_63\n";
                            }
                            if ((srcAddr == 10)) {
                              if(!coveragePoints["Data_path_64"]){
                                coveragePoints["Data_path_64"] = true;
                                coveragePointsCount++;
                                std::cout<<"Coverage Percentage: Data_path_64\n";
                              }
                              ...
                              if(!coveragePoints["Data_path_65"]){
                                ...
                                coveragePointsCount++;
                                std::cout<<"Coverage Percentage: Data_path_65\n";
                              }
                              if ((srcAddr == 11)) {
                                if(!coveragePoints["Data_path_66"]){
                                  coveragePoints["Data_path_66"] = true;
                                  coveragePointsCount++;
                                  std::cout<<"Coverage Percentage: Data_path_66\n";
                                }
                                ...
                                if(!coveragePoints["Data_path_67"]){
                                  ...
                                  coveragePointsCount++;
                                  std::cout<<"Coverage Percentage: Data_path_67\n";
                                }
                                if ((srcAddr == 12)) {
                                  if(!coveragePoints["Data_path_68"]){
                                    coveragePoints["Data_path_68"] = true;
                                    coveragePointsCount++;
                                    std::cout<<"Coverage Percentage: Data_path_68\n";
                                  }
                                  ...
                                  if(!coveragePoints["Data_path_69"]){
                                    ...
                                    coveragePointsCount++;
                                    std::cout<<"Coverage Percentage: Data_path_69\n";
                                  }
                                  if ((srcAddr == 13)) {
                                    if(!coveragePoints["Data_path_70"]){
                                      coveragePoints["Data_path_70"] = true;
                                      coveragePointsCount++;
                                      std::cout<<"Coverage Percentage: Data_path_70\n";
                                    }
                                    ...
                                    if(!coveragePoints["Data_path_71"]){
                                      ...
                                      coveragePointsCount++;
                                      std::cout<<"Coverage Percentage: Data_path_71\n";
                                    }
                                    if ((srcAddr == 14)) {
                                      if(!coveragePoints["Data_path_72"]){
                                        coveragePoints["Data_path_72"] = true;
                                        coveragePointsCount++;
                                        std::cout<<"Coverage Percentage: Data_path_72\n";
                                      }
                                      ...
                                      if(!coveragePoints["Data_path_73"]){
                                        ...
                                        coveragePointsCount++;
                                        std::cout<<"Coverage Percentage: Data_path_73\n";
                                      }
                                      if ((srcAddr == 15)) {
                                        if(!coveragePoints["Data_path_74"]){
                                          coveragePoints["Data_path_74"] = true;
                                          coveragePointsCount++;
                                          std::cout<<"Coverage Percentage: Data_path_74\n";
                                        }
                                        ...
                                        if(!coveragePoints["Data_path_75"]){
                                          ...
                                          coveragePointsCount++;
                                          std::cout<<"Coverage Percentage: Data_path_75\n";
                                        }
                                        if ((srcAddr == 16)) {
                                          if(!coveragePoints["Data_path_76"]){
                                            coveragePoints["Data_path_76"] = true;
                                            coveragePointsCount++;
                                            std::cout<<"Coverage Percentage: Data_path_76\n";
                                          }
                                          ...
                                          if(!coveragePoints["Data_path_77"]){
                                            ...
                                            coveragePointsCount++;
                                            std::cout<<"Coverage Percentage: Data_path_77\n";
                                          }
                                          if ((srcAddr == 17)) {
                                            if(!coveragePoints["Data_path_78"]){
                                              coveragePoints["Data_path_78"] = true;
                                              coveragePointsCount++;
                                              std::cout<<"Coverage Percentage: Data_path_78\n";
                                            }
                                            ...
                                            if(!coveragePoints["Data_path_79"]){
                                              ...
                                              coveragePointsCount++;
                                              std::cout<<"Coverage Percentage: Data_path_79\n";
                                            }
                                            if ((srcAddr == 18)) {
                                              if(!coveragePoints["Data_path_80"]){
                                                coveragePoints["Data_path_80"] = true;
                                                coveragePointsCount++;
                                                std::cout<<"Coverage Percentage: Data_path_80\n";
                                              }
                                              ...
                                              if(!coveragePoints["Data_path_81"]){
                                                ...
                                                coveragePointsCount++;
                                                std::cout<<"Coverage Percentage: Data_path_81\n";
                                              }
                                              if ((srcAddr == 19)) {
                                                if(!coveragePoints["Data_path_82"]){
                                                  coveragePoints["Data_path_82"] = true;
                                                  coveragePointsCount++;
                                                  std::cout<<"Coverage Percentage: Data_path_82\n";
                                                }
                                                ...
                                                if(!coveragePoints["Data_path_83"]){
                                                  ...
                                                  coveragePointsCount++;
                                                  std::cout<<"Coverage Percentage: Data_path_83\n";
                                                }
                                                if ((srcAddr == 20)) {
                                                  if(!coveragePoints["Data_path_84"]){
                                                    coveragePoints["Data_path_84"] = true;
                                                    coveragePointsCount++;
                                                    std::cout<<"Coverage Percentage: Data_path_84\n";
                                                  }
                                                  ...
                                                  if(!coveragePoints["Data_path_85"]){
                                                    ...
                                                    coveragePointsCount++;
                                                    std::cout<<"Coverage Percentage: Data_path_85\n";
                                                  }
                                                  if ((srcAddr == 21)) {
                                                    if(!coveragePoints["Data_path_86"]){
                                                      coveragePoints["Data_path_86"] = true;
                                                      coveragePointsCount++;
                                                      std::cout<<"Coverage Percentage: Data_path_86\n";
                                                    }
                                                    ...
                                                    if(!coveragePoints["Data_path_87"]){
                                                      ...
                                                      coveragePointsCount++;
                                                      std::cout<<"Coverage Percentage: Data_path_87\n";
                                                    }
                                                    if ((srcAddr == 22)) {
                                                      if(!coveragePoints["Data_path_88"]){
                                                        coveragePoints["Data_path_88"] = true;
                                                        coveragePointsCount++;
                                                        std::cout<<"Coverage Percentage: Data_path_88\n";
                                                      }
                                                      ...
                                                      if(!coveragePoints["Data_path_89"]){
                                                        ...
                                                        coveragePointsCount++;
                                                        std::cout<<"Coverage Percentage: Data_path_89\n";
                                                      }
                                                      if ((srcAddr == 23)) {
                                                        if(!coveragePoints["Data_path_90"]){
                                                          coveragePoints["Data_path_90"] = true;
                                                          coveragePointsCount++;
                                                          std::cout<<"Coverage Percentage: Data_path_90\n";
                                                        }
                                                        ...
                                                        if(!coveragePoints["Data_path_91"]){
                                                          ...
                                                          coveragePointsCount++;
                                                          std::cout<<"Coverage Percentage: Data_path_91\n";
                                                        }
                                                        if ((srcAddr == 24)) {
                                                          if(!coveragePoints["Data_path_92"]){
                                                            coveragePoints["Data_path_92"] = true;
                                                            coveragePointsCount++;
                                                            std::cout<<"Coverage Percentage: Data_path_92\n";
                                                          }
                                                          ...
                                                          if(!coveragePoints["Data_path_93"]){
                                                            ...
                                                            coveragePointsCount++;
                                                            std::cout<<"Coverage Percentage: Data_path_93\n";
                                                          }
                                                          if ((srcAddr == 25)) {
                                                            if(!coveragePoints["Data_path_94"]){
                                                              coveragePoints["Data_path_94"] = true;
                                                              coveragePointsCount++;
                                                              std::cout<<"Coverage Percentage: Data_path_94\n";
                                                            }
                                                            ...
                                                            if(!coveragePoints["Data_path_95"]){
                                                              ...
                                                              coveragePointsCount++;
                                                              std::cout<<"Coverage Percentage: Data_path_95\n";
                                                            }
                                                            if ((srcAddr == 26)) {
                                                              if(!coveragePoints["Data_path_96"]){
                                                                coveragePoints["Data_path_96"] = true;
                                                                coveragePointsCount++;
                                                                std::cout<<"Coverage Percentage: Data_path_96\n";
                                                              }
                                                              ...
                                                              if(!coveragePoints["Data_path_97"]){
                                                                ...
                                                                coveragePointsCount++;
                                                                std::cout<<"Coverage Percentage: Data_path_97\n";
                                                              }
                                                              if ((srcAddr == 27)) {
                                                                if(!coveragePoints["Data_path_98"]){
                                                                  coveragePoints["Data_path_98"] = true;
                                                                  coveragePointsCount++;
                                                                  std::cout<<"Coverage Percentage: Data_path_98\n";
                                                                }
                                                                ...
                                                                if(!coveragePoints["Data_path_99"]){
                                                                  ...
                                                                  coveragePointsCount++;
                                                                  std::cout<<"Coverage Percentage: Data_path_99\n";
                                                                }
                                                                if ((srcAddr == 28)) {
                                                                  if(!coveragePoints["Data_path_100"]){
                                                                    coveragePoints["Data_path_100"] = true;
                                                                    coveragePointsCount++;
                                                                    std::cout<<"Coverage Percentage: Data_path_100\n";
                                                                  }
                                                                  ...
                                                                  if(!coveragePoints["Data_path_101"]){
                                                                    ...
                                                                    coveragePointsCount++;
                                                                    std::cout<<"Coverage Percentage: Data_path_101\n";
                                                                  }
                                                                  if ((srcAddr == 29)) {
                                                                    if(!coveragePoints["Data_path_102"]){
                                                                      coveragePoints["Data_path_102"] = true;
                                                                      coveragePointsCount++;
                                                                      std::cout<<"Coverage Percentage: Data_path_102\n";
                                                                    }
                                                                    ...
                                                                    if(!coveragePoints["Data_path_103"]){
                                                                      ...
                                                                      coveragePointsCount++;
                                                                      std::cout<<"Coverage Percentage: Data_path_103\n";
                                                                    }
                                                                    if ((srcAddr == 30)) {
                                                                      if(!coveragePoints["Data_path_104"]){
                                                                        coveragePoints["Data_path_104"] = true;
                                                                        coveragePointsCount++;
                                                                        std::cout<<"Coverage Percentage: Data_path_104\n";
                                                                      }
                                                                      ...
                                                                      if(!coveragePoints["Data_path_105"]){
                                                                        ...
                                                                        coveragePointsCount++;
                                                                        std::cout<<"Coverage Percentage: Data_path_105\n";
                                                                      }
        ...
        if(!coveragePoints["Data_path_106"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Data_path_106\n";
        }
        return(0);
      }
    }
    ...
    unsigned getWBdata(unsigned aluResult_s5, unsigned loadedData, unsigned pc_s5, RF_WriteDataSelType wbSel_s5) {
      if ((wbSel_s5 == WB_ALU)) {
        if(!coveragePoints["Data_path_107"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Data_path_107\n";
        }
        return(aluResult_s5);
      } else {
        if(!coveragePoints["Data_path_108"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Data_path_108\n";
        }
        if ((wbSel_s5 == WB_MEM)) {
          if(!coveragePoints["Data_path_109"]){
            coveragePoints["Data_path_109"] = true;
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Data_path_109\n";
          }
          return(loadedData);
        } else {
          if(!coveragePoints["Data_path_110"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Data_path_110\n";
          }
          if ((wbSel_s5 == WB_PC4)) {
            if(!coveragePoints["Data_path_111"]){
              coveragePoints["Data_path_111"] = true;
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Data_path_111\n";
            }
            return((pc_s5 + 4));
          } else {
            if(!coveragePoints["Data_path_112"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Data_path_112\n";
            }
            return(0);
          }
        }
    ...
    unsigned regContentFwdUnit(unsigned aluResult_s4, unsigned aluResult_s5, unsigned dstAddr_s4, unsigned dstAddr_s5, EncType encType_s4, EncType encType_s5, unsigned loadedData, unsigned pc_s4, unsigned pc_s5, unsigned regContent, unsigned srcAddr) {
      if ((srcAddr == 0)) {
        if(!coveragePoints["Data_path_113"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Data_path_113\n";
        }
        return(0);
      } else {
        if(!coveragePoints["Data_path_114"]){
          ...
          coveragePointsCount++;
          std::cout<<"Coverage Percentage: Data_path_114\n";
        }
        if ((((srcAddr == dstAddr_s5) and (encType_s5 == ENC_I_L)) and (srcAddr != dstAddr_s4))) {
          if(!coveragePoints["Data_path_115"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Data_path_115\n";
          }
          return(loadedData);
        } else {
          if(!coveragePoints["Data_path_116"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Data_path_116\n";
          }
          if (((srcAddr == dstAddr_s5) and ((encType_s5 == ENC_I_J) or (encType_s5 == ENC_J)))) {
            if(!coveragePoints["Data_path_117"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Data_path_117\n";
            }
            return((pc_s5 + 4));
          } else {
              ...
              if ((srcAddr == dstAddr_s4)) {
                ...
                if ((srcAddr == dstAddr_s5)) {
                  ...
                  if(!coveragePoints["Data_path_124"]){
                    ...
                    coveragePointsCount++;
                    std::cout<<"Coverage Percentage: Data_path_124\n";
                  }
                  return(regContent);
                }
              }
      ...
      while(true) {
        if (section==executeStage) {
          if(!coveragePoints["Data_path_125"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Data_path_125\n";
          }
          ...
          if ((CUtoDP_data.dmemReq_s4 == ME_RD)) {
            ...
            if ((CUtoDP_data.dmemReq_s4 == ME_WR)) {
              ...
              if(!coveragePoints["Data_path_130"]){
                ...
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Data_path_130\n";
              }
          ...
          if (((((CUtoDP_data.prevDmemAccess and (DP_S3_data.encType_s3 == ENC_S)) and (DP_S5_data.encType_s5 == ENC_I_L)) and (DP_S3_data.regRs2Addr_s3 == DP_S5_data.regRdAddr_s5)) and (DP_S5_data.regRdAddr_s5 != 0))) {
            if(!coveragePoints["Data_path_131"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Data_path_131\n";
            }
            ...
            if(!coveragePoints["Data_path_132"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Data_path_132\n";
            }
            if ((DP_S4_data.fwdPrevLoadedData and CUtoDP_data.stallDmemAccess)) {
              if(!coveragePoints["Data_path_133"]){
                ...
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Data_path_133\n";
              }
              DP_S4_data.fwdPrevLoadedData = true;
            } else {
              if(!coveragePoints["Data_path_134"]){
                ...
                coveragePointsCount++;
                std::cout<<"Coverage Percentage: Data_path_134\n";
              }
          ...
          if(!coveragePoints["Data_path_135"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Data_path_135\n";
          }
          ...
          if (rec) {
            if(!coveragePoints["Data_path_136"]){
              ...
              coveragePointsCount++;
              std::cout<<"Coverage Percentage: Data_path_136\n";
            }
          ...
          if(!coveragePoints["Data_path_139"]){
            ...
            coveragePointsCount++;
            std::cout<<"Coverage Percentage: Data_path_139\n";
          }
