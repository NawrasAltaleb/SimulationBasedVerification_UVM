...
public:
    vip_sequencer<vip_trans_bus_req_t> *sequencer;
    vip_driver<vip_trans_bus_req_t> *driver;
    ...
    void build_phase(uvm_phase &phase) {
        ...
        if (get_is_active() == uvm::UVM_ACTIVE) {
            ...
            sequencer = vip_sequencer<vip_trans_bus_req_t>::type_id::create("sequencer", this);
            assert(sequencer);

            driver = vip_driver<vip_trans_bus_req_t>::type_id::create("driver", this);
            assert(driver);
