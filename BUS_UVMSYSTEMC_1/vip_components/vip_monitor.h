...
//    vip_if_BUS_RSP *vif_SlaveToBus; /// Placeholder needed to store the handle to the interface object
    ...
    void build_phase(uvm_phase &phase) {
        ...
        /// Get interface object using the configuration mechanism
//        if (!uvm_config_db<vip_if_BUS_RSP *>::get(this, "*", "vif_SlaveToBus", vif_SlaveToBus))
//            UVM_FATAL(this->get_name(), "Virtual interface not defined! Simulation aborted!");
...
//        vip_trans_bus_req_t t;
//        vip_trans_bus_resp_t t2;
//        while (true) // monitor forever
//        {
//            vif_BusToSlave->BUS_REQ.read(t.bus_req);
//            item_collected_port_Slave_REQ.write(t);
//            t2.bus_resp.data = t.bus_req.data;
//            t2.bus_resp.ack = OK;
//            vif_SlaveToBus->BUS_RSP.write(t2.bus_resp);
//        }
    }
