...
#ifndef PROJECT_GOLDEN_BUS_H
#define PROJECT_GOLDEN_BUS_H

struct GoldenBus : public sc_module {
    ...
    //Constructor
    SC_HAS_PROCESS(GoldenBus);

    GoldenBus(sc_module_name name) :
            master_in("master_in"),
    ...
    void fsm() {
        ...
        while (true) {
             ...
             */
            master_in->read(req);
//            std::cout << "req addrs:" << req.addr << " data:" << req.data << " mode:" << req.trans_type << std::endl;
